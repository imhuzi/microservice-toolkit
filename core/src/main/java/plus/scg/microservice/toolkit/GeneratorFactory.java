...
package plus.scg.microservice.toolkit;
...
public class GeneratorFactory {
  ...
  static {
    addGeneratorType(plus.scg.microservice.toolkit.CodeGenerator.class);
    addGeneratorType(plus.scg.microservice.toolkit.DocGenerator.class);
    addGeneratorType(plus.scg.microservice.toolkit.ContractsGenerator.class);
  }
