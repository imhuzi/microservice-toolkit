...
package com.uyibai.microservice.toolkit;
...
public class GeneratorFactory {
  ...
  static {
    addGeneratorType(com.uyibai.microservice.toolkit.CodeGenerator.class);
    addGeneratorType(com.uyibai.microservice.toolkit.DocGenerator.class);
    addGeneratorType(com.uyibai.microservice.toolkit.ContractsGenerator.class);
  }
