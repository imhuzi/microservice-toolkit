...
package com.uyibai.microservice.toolkit.generator.contract;

import com.uyibai.microservice.toolkit.ContractsGenerator;
import com.uyibai.microservice.toolkit.common.ContractFileType;
import com.uyibai.microservice.toolkit.common.ImmediateClassLoader;
...
import static com.uyibai.microservice.toolkit.common.ContractFileType.YAML;
...
public class DefaultContractsGenerator implements ContractsGenerator {
  ...
  private static boolean canProcess(Class<?> loadClass) {
    ...
    DubboService restSchema = loadClass.getAnnotation(DubboService.class);
    if (restSchema != null) {
      return true;
    }
