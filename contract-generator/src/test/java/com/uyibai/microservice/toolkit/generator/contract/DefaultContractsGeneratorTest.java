...
import com.uyibai.microservice.toolkit.GeneratorFactory;
import com.uyibai.microservice.toolkit.common.ClassMaker;
...
public class DefaultContractsGeneratorTest {
  ...
  private static final String TEST_PROJECT = "projects/demo";
  ...
  public void testPrivateCanProcess() throws Exception {
    ...
    mockClass = contractTestUtil.putAnnotationToClass("TestRestSchema", DubboService.class);
